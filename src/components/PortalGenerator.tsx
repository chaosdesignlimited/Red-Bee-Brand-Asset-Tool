...
// Branded hero background: a red portal generated by the tool itself, cropped to
// bleed right and darkened on the left so the white headline reads over it.
// 'slice' makes it cover the header; 'h' namespaces its gradient IDs so they
// don't collide with the live preview ('p'). Computed once (pure, isomorphic).
const HERO_SVG = buildScene(
  {
    family: 'red',
    canvasW: 1600,
    canvasH: 400,
  ...
  'h',
).svg.replace('xMidYMid meet', 'xMidYMid slice');
...
export default function PortalGenerator() {
  ...
  return (
    <div className="page">
      <header className="hero">
        ...
        <div className="hero-inner">
          <div className="hero-top">
            <span className="brandmark" aria-label="Red Bee">
              <span>RED</span>
              <span>BEE</span>
            </span>
            <span className="hero-eyebrow">Brand Asset Tool</span>
          </div>
          <div className="hero-copy">
            ...
            <p>
              On-brand portal graphics at any pixel size — export PNG, JPEG or SVG. Moving Media
              Forward.
            </p>
          </div>
        </div>
      ...
      <footer className="brandfoot">
        <div className="brandfoot-inner">
          <span className="mmf">
            Moving Media Forward<span className="stop">.</span>
          </span>
          <span className="meta">
