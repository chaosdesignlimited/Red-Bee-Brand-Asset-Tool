    ...
    <div className="page">
      <header className="masthead">
        <svg className="mark" viewBox="0 0 64 64" aria-hidden="true">
          <rect width="64" height="64" fill="#dc281e" />
          <rect x="9" y="9" width="46" height="46" fill="#961b12" />
          <rect x="18" y="18" width="28" height="28" fill="#500e07" />
          <rect x="26" y="26" width="12" height="12" fill="#2d0701" />
        </svg>
        <div>
          <h1>
            Red Bee Portal Generator<span className="stop" aria-hidden="true">.</span>
          </h1>
          <p>Generate on-brand portal graphics — export PNG, JPEG or SVG.</p>
        </div>
      </header>
      ...
      <footer className="appfoot">
        <span>
          Moving Media Forward<span className="stop" aria-hidden="true">.</span>
        </span>
        <a href="https://www.redbeemedia.com/" target="_blank" rel="noopener noreferrer">
          redbeemedia.com
        </a>
        <span>Part of Ericsson</span>
      </footer>
    </div>
  );
}
